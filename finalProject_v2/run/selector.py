import sac_policy_pkg
import dqn_policy_pkg
...
def get_dqn_trainer():
    ...
    sac_policy_path = r'$PROJ_PATH/save/sac_policy/sac/eval_policy'
    dqn_policy_path = r'$PROJ_PATH/save/dqn_policy/dqn/eval_policy'
    ...
    hierarchy_wrapper = functools.partial(
        ...
        policies=[(sac_policy, sac_policy_pkg.get_state, process_action_sac, sac_policy_pkg.state_min, sac_policy_pkg.state_max)] +
                 [(dqn_policy, dqn_policy_pkg.get_state, process_action_dqn, dqn_policy_pkg.state_min, dqn_policy_pkg.state_max)]
    )
